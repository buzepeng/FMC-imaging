...
int main(){
    ...
    fmc_img.read_FMC("/home/hilbert/data/YJBL_5L64_0p5_100MHz_4000.csv", fmc_img.h_offLineFmc, WaveNum, iWaveLength);
    std::cout<<"Reading TOF..."<<std::endl;
    fmc_img.read_TOF("/home/hilbert/data/TOF_Data_40_40_0p04Plane.csv", fmc_img.h_iTof, col_tof, row_tof);
    ...
    cudaMemcpy(fmc_img.d_offLineFmc, fmc_img.h_offLineFmc, iWaveLength*WaveNum*sizeof(float), cudaMemcpyHostToDevice);
    std::cout<<"Filtering..."<<std::endl;
    fmc_img.filtering(fmc_img.d_offLineFmc, fmc_img.d_f_filter, fmc_img.d_f_offLineFmc);
