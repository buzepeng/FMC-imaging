...
__global__ void hilbert_transform_kernel(cufftComplex* signals, cufftComplex* filter, int WaveNum, int WaveLength){
    ...
    if(iy<WaveNum && ix<WaveLength){
        int sig_idx = (ix<int(WaveLength/2))?(iy*WaveLength+ix):(iy*WaveLength+WaveLength-ix);
...
class FmcImaging{
    ...
    public:
        ...
        cufftComplex *d_Hilbert, *d_f_offLineFmc;
        ...
        void hilbert_transform(float* offLineFmc_filted, cufftComplex* f_offLineFmc, cufftComplex* HilbertFilter);
...
void FmcImaging::hilbert_transform(float* offLineFmc_filted, cufftComplex* f_offLineFmc, cufftComplex* HilbertFilter){
