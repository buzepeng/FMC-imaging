...
class FmcImaging{
    ...
    public:
        short *h_iTof, *d_iTof;
        float *h_offLineFmc, *d_offLineFmc, *d_offLineFmc_filted, *d_TfmImage;
        cufftComplex *d_Hilbert, *d_f_offLineFmc, *d_HilbertMat, *d_f_filter;
        ...
        void get_filter(float f1, float f2, cufft* filter);
