...
struct thrust_imaging{
    ...
    thrust_imaging(float *_offLineFmc, short *_Tof, cufft *_FmcMatHilbert, int _WaveNum, int _iWaveLength, int _WaveLength, int _col_tof):offLineFmc(_offLineFmc), Tof(_Tof), FmcMatHilbert(_FmcMatHilbert), WaveNum(_WaveNum), iWaveLength(_iWaveLength), WaveLength(_WaveLength), col_tof(_col_tof){};
    __device__
