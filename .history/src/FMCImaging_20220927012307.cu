...
int main(){
    ...
    // }
    cudamemcpy(fmc_img.d_offLineFmc, fmc_img.h_offLineFmc, iWaveLength*WaveNum*sizeof(float));
    std::cout<<"Filtering..."<<std::endl;
    fmc_img.filtering(fmc_img.d_offLineFmc_data, fmc_img.d_filter, fmc_img.d_offLineFmc_filted);
    ...
    fmc_img.imaging(fmc_img.d_offLineFmc_ind, fmc_img.d_iTof, fmc_img.d_f_offLineFmc, fmc_img.d_TfmImage, MindB);
