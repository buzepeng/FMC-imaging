...
struct thrust_imaging{
    ...
    thrust_imaging(float *_offLineFmc_ind, short *_Tof, cufftComplex *_FmcMatHilbert, int _WaveNum, int _WaveLength,int iWaveLength int _col_tof):offLineFmc_ind(_offLineFmc_ind), Tof(_Tof), FmcMatHilbert(_FmcMatHilbert), WaveNum(_WaveNum), WaveLength(_WaveLength), col_tof(_col_tof){};
    __device__
